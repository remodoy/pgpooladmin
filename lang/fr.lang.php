...
$message = array(
    'lang' => 'fr',
    'strLang' => 'Français',
    'descBackend_flag' => 'Autorise le failover et le détachement/attachement du noeud failover',
    ...
    'descDebug_level' => 'Niveau de verbosité des messages de debogage',
    ...
    'descFollow_master_command' => 'Commande à exécuter seulement après un failover du maître',
    ...
    'descRelcache_expire' => 'Durée de vide du cache de relations en secondes',
    ...
    'descSr_check_period' => 'Délai (en secondes) entre chaque vérification du lag de la réplication en flux',
    'descSr_check_user' => 'Nom de l\'utilisateur PostgreSQL qui réalise la vérification du lag de réplication en flux',
    'descSr_check_password' => 'Mot de passe de l\'utilisateur PostgreSQL qui réalise la vérification du lag de réplication en flux',
    'descSyslog_facility' => 'Niveau syslog',
    'descSyslog_ident' => 'Identification du programme pour syslog',
    ...
    'errIllegalPipe' => 'Destination du tube illégal',
    ...
    'msgRPromoteConfirm' => 'Souhaitez-vous réellement transformer ce noeud en noeud primaire ?',
    'strAdd' => 'Ajouter',
    ...
    'strPgpoolLogFile' => 'Destination du journal pgpool',
    ...
    'strStandbyRunning' => 'Serveur standby',
